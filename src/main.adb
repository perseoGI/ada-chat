...
begin
   ...
   Diffie_Hellman_Public :=
     DiffieHellman.Compute
       (Base => Base, Exp => Diffie_Hellman_Secret, Modulus => Modulus);
   ...
   --  3.2. Interchange Modulus, Base and public secret TODO 3.3. Initiate RC4
   --  cipher on both sides TODO
